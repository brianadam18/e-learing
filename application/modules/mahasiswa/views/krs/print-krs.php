    ...
    <div class="wrapper">
      ...
      <table width="80%" align="center" style="margin-bottom: 5px; text-align:left">
          ...
          <tr>
              ...
              <td><?php echo ucfirst($data_krs[0]->semester); ?></td>
              <td width="100"></td>
              <th width="90">Tahun Akademik </th>  <td width="10" style="text-align:center;">:</td>
              <td><?php echo $data_krs[0]->years; ?></td>
          </tr>
      </table>
      <table class="gridtable mini-font" width="100%">
        <thead>
            <tr>
                ...
                <th rowspan="2" width="70">Kode MK</th>
                <th rowspan="2">Mata Kuliah</th>
                <th rowspan="2">SKS</th>
                <th colspan="2" width="50">Verifikasi</th>
            </tr>
            <tr>
                <th>Disetujui</th>
                <th>Belum</th>
        ...
        ?>
              <tr>
                ...
                <td class="text-center"><?php echo ($value->verification) ? '<i class="fa fa-check"></i>' : ''; ?></td>
                <td class="text-center"><?php echo ($value->verification) ? '' : '<i class="fa fa-check"></i>'; ?></td>
              </tr>
        <?php 
          $total_sks += $value->sks; 
        ...
        <tfoot>
            <tr>
                ...
                <th colspan="3"><?php echo $total_sks; ?></th>
            </tr>
        </tfoot>
      </table>
            <table style="padding-top: 10px; width: 50%; float: left; border: none;">
              <tr>
                 ...
                 <td style="width: 50%; text-align: left; font-weight: normal;">
                  <p><small>
                    <strong><i>NB :</i></strong><br>Kartu Rencana Studi ini dicetak dengan layanan sistem dan, dinyatakan sah apabila sudah ditanda tangani oleh Ketua Program Studi dan dicap stempel STIE Pertiba di Bagian Akademik.
                  </small></p>
                 </td> 
              </tr>
           </table>
