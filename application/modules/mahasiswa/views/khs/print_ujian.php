...
<html>
   <head>
      ...
      <style>
         ...
         table { font-size:13px; font-family:'Arial Narrow'; }
         ...
         table.mini-font { font-size: 13px; }
         table.gridtable { border-width: 0; border-color: #757572; border-collapse: collapse; }
         table.gridtable th {  border-width: 0.1px; padding: 7px; border-style: solid; border-color: #757572; text-transform: none; }
      ...
      <table class="gridtable mini-font" width="100%">
                    ...
                    ?>
                            <tr>
                                ...
                                <td style="padding-left: 10px;">
                                  ...
                                  <small><i>
                                    <?php echo $value->course_name_english; ?>
                                  </i></small>    
                                </td>
        ...
        <tfoot>
            <tr>
                ...
                <th colspan="3" style="text-align:left; padding-left: 28px;"><?php echo $sks; ?></th>
            </tr>
        </tfoot>
      </table>
