...
<html>
   <head>
      ...
      <style>
         ...
         table.gridtable th {  border-width: 0.1px; padding: 2.5px; border-style: solid; border-color: #757572; text-transform: none; }
         table.gridtable td { border-width: 0.1px; border-top: 0px; padding: 2.5px 3px 3px 3px; border-style: solid; border-color: #757572; }
   ...
   <body>
    ...
    <div class="wrapper">
      ...
      <table class="gridtable mini-font" width="100%">
        ...
        <tfoot>
            <tr>
                <th colspan="3" style="text-align: right;">Jumlah SKS yang sudah ditempuh :</th>
                <th><?php echo $sks; ?></th>
                <th colspan="6" style="text-align: right;">Jumlah Bobot :</th>
                <th><?php echo $bobot; ?></th>
            </tr>
            <tr>
                <th colspan="3" style="text-align: right;">Jumlah SKS yang harus ditempuh : </th>
                <th><?php echo 153; ?></th>
                <th rowspan="2" colspan="6" style="text-align: right;">Index Prestasi Kumulatif (IPK) :</th>
                <th rowspan="2"><?php echo str_replace('.', ',', substr($ipk, 0, 5)); ?></th>
            </tr>
            <tr>
                <th colspan="3" style="text-align: right;">Jumlah SKS yang tersisa :</th>
                <th><?php echo (153-$sks); ?></th>
            </tr>
        </tfoot>
      </table>
            <table style="padding-top: 10px; width: 50%; float: left; border: none;">
              <tr>
                 ...
                 <td style="width: 50%; text-align: left; font-weight: normal;">
                  <p><small>
                    <strong><i>NB :</i></strong><br>Transkrip Nilai ini dicetak dengan layanan sistem dan, dinyatakan sah apabila sudah ditanda tangani oleh Ketua Program Studi dan dicap stempel STIE Pertiba di Bagian Akademik.
                  </small></p>
                 </td> 
              </tr>
           </table>
