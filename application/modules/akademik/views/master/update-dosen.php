...
?>
			<div class="box-body" style="margin-top: 10px;">
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="lecturer_code" class="form-control" value="<?php echo $get->lecturer_code; ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="nidn" class="form-control" value="<?php echo $get->nidn; ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<textarea name="address" class="form-control" rows="3"><?php echo $get->address; ?></textarea>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
				           ...
				           <input name="status" type="radio" value="ds_tetap" <?php if($get->status=='ds_tetap') echo "checked"; ?>> <label for="status"> Dosen Tetap</label>
				       	</div>
				       	<div class="radio radio-inline radio-info">
				           <input name="status" type="radio" value="ds_luar_biasa" <?php if($get->status=='ds_luar_biasa') echo "checked"; ?>> <label for="status"> Dosen Luar Biasa</label>
				       	</div>
