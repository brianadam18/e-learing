...
?>
			<div class="box-body" style="margin-top: 10px;">
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="course_code" class="form-control" value="<?php echo $get->course_code; ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="course_name" class="form-control" value="<?php echo $get->course_name; ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="course_name_english" class="form-control" value="<?php echo $get->course_name_english; ?>">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="sks" class="form-control" value="<?php echo $get->sks; ?>">
