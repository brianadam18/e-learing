...
<html>
   ...
   <body>
    ...
    <div class="wrapper">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  ...
                  <?php 
                    if($row->concentration_id==1)  
                    echo '<strong>*</strong>';
                    elseif($row->concentration_id==2) 
                      echo '<strong>**</strong>';  
                  ?>
                  <br>
      ...
      <small>
        NB: 
        Keterangan Konsentrasi <br>
        <strong>* : </strong> Manajemen Pemasaran <br>
        <strong>** :</strong> Manajemen Keuangan
      </small>
      </p>
