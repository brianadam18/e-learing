			...
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
				           ...
				           <input name="gender" type="radio" required="" value="pria"> <label for="gender"> Pria</label>
				       	</div>
				       	<div class="radio radio-inline radio-info">
				           <input name="gender" type="radio" required="" value="wanita"> <label for="gender"> Wanita</label>
				       	</div>
					</div>
				</div>
				<div class="form-group">
