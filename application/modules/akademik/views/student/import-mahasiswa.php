 ...
 * @var string
 **/
echo form_open_multipart(site_url("akademik/student/set_import"), array('class' => 'form-horizontal', 'id' => 'form-import-mahasiswa'))	
?>
			...
			<div class="box-footer with-border">
				<div class="col-md-4 col-xs-5">
					<a href="<?php echo site_url('akademik/student') ?>" class="btn btn-app pull-right">
