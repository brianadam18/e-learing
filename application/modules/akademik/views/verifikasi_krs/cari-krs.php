		...
		<div class="box pad box-primary">
			...
			<div class="box-body with-border">
				...
				<div class="col-md-3">
					...
					<a href="<?php echo site_url('akademik/verifikasi_krs') ?>" class="btn btn-app">
				...
				<div class="col-md-4">
					<table>
						...
						<tr>
							...
							<td><?php echo ($data_krs) ? str_replace('.', ',', $this->nilai->getIp()) : ''; ?></td>
						</tr>
						<tr>
							<th>Maksimum kredit SKS </th><th width="30" class="text-center">:</th>
							<td><?php echo ($data_krs) ? $this->nilai->credit_sks() . ' SKS': ''; ?></td>
						</tr>
					</table>
				</div>
<?php 
// Form Open KRS
echo form_open(site_url("akademik/verifikasi_krs/set_action/{$get->student_id}"), array('id' => 'form-krs')); 
echo form_hidden('query_string', $this->input->server('QUERY_STRING'));
echo form_hidden('npm', $get->npm);
echo form_hidden('student_id', $get->student_id);
...
?>
				<div class="col-md-2">
					<a href="<?php echo site_url("akademik/verifikasi_krs/getprint?{$this->input->server('QUERY_STRING')}"); ?>" class="btn btn-app btn-print"><i class="fa fa-print"></i> Cetak</a>
					<a class="btn btn-app jadikan-khs"><i class="fa fa-file-text-o"></i> Jadikan KHS</a>
				</div>
				...
				<div class="col-md-12"><hr>
					<div class="col-md-8 col-md-offset-2 col-xs-12">
						<div class="alert alert-warning animated bounce">
							...
							<strong><i class="fa fa-warning"></i> Maaf!</strong> <p>Mahasiswa belum menyusun KRS, atau data tidak ditemukan.</p>
						</div>
					</div>
				</div>
	<?php
...
/* Location: ./application/modules/Akademik/views/verifikasi_krs/cari-krs.php */
?>